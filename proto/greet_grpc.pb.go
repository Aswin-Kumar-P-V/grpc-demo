...
type GreetServiceClient interface {
	SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloRespone, error)
...
func (c *greetServiceClient) SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloRespone, error) {
...
func (x *greetServiceSayHelloServerStreamingClient) Recv() (*HelloRespone, error) {
	m := new(HelloRespone)
...
func (x *greetServiceSayHelloClientStreamingClient) Send(m *HelloRespone) error {
...
func (x *greetServiceSayHelloBidirectionalStreamingClient) Recv() (*HelloRespone, error) {
	m := new(HelloRespone)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	SayHello(context.Context, *NoParam) (*HelloRespone, error)
...
func (UnimplementedGreetServiceServer) SayHello(context.Context, *NoParam) (*HelloRespone, error) {
...
func (x *greetServiceSayHelloServerStreamingServer) Send(m *HelloRespone) error {
...
func (x *greetServiceSayHelloClientStreamingServer) Recv() (*HelloRespone, error) {
	m := new(HelloRespone)
...
func (x *greetServiceSayHelloBidirectionalStreamingServer) Send(m *HelloRespone) error {
	return x.ServerStream.SendMsg(m)
}
